...
public class CartSteps {
    ...
    String expectedTextCheckoutButton = "Checkout";
    ...
    public void checks_the_correctness_of_the_prices() {
        ...
        System.out.println("actualPriceFirstProduct: " + actualUnitPriceFirstProduct);
        ...
        System.out.println("actualTotalPriceFirstProduct: " + actualTotalPriceFirstProduct);
        ...
        System.out.println("actualUnitPriceSecondProduct: " + actualUnitPriceSecondProduct);
        ...
        System.out.println("actualTotalPriceSecondProduct: " + actualTotalPriceSecondProduct);
    ...
    public void clicks_on_the_checkout_button() {
        ...
        String actualTextCheckoutButton =  driver.findElement(By.cssSelector("button[class='btn btn-success']")).getText();
        System.out.println("actualCheckoutButton: " + actualTextCheckoutButton);
        Assert.assertEquals(actualTextCheckoutButton, expectedTextCheckoutButton);
